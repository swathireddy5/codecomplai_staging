          ...
          <!-- sidebar-search  -->
            ...
            <ul>
              ...
              <li class="sidebar-dropdown" id="${book.value}">
                                 ...
                                 <a href="/codecompilance/selectedStateBookList?statename=<c:out value="${book.value}"/>">
      ...
      <div class="col-xl-6">
        ...
        <li >
                <div>
                  ...
                  <label class="label" onclick="javascript:show_chapter_content('${myIndex.count}');" style="cursor: pointer;font-weight:bold;"> <c:out value="${result.sectionVal}"/></label>
                </div>
              </li>
    </c:forEach>
...
function show_bookgraph(bookID, bookName){
	...
	data: { bookID: bookID, bookName: bookName},
		success : function(response){
			...
			$("#contentForSelectedSec").val("");
			$("#leftPanelID").val("Content");
			$("#rightPanelID").val("Graph");
	...
	//	alert(chapterID+chapterName+chapterDivID);
		...
		data: { chapterID: chapterID, chapterName: chapterName},
			...
			//	$("#contentForSelectedSec").append("<p>"+content+"</p>");
				$('#contentForSelectedSec').html("<p>"+content+"</p>");
				if(subchapters){
