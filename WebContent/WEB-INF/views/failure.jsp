...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container">
	<div class="row">
	<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100" style="margin-top: 100px;">
					<div class="card">
							<div class="card-body">
								<div class="m-sm-4">
								<label style="font-style:bold;">Sorry, Rasa connection Failed. Please check... </label>
								</div>
							</div>
						</div>
