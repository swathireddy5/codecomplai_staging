    ...
    <div class="container-fluid d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block float-right">
        <ul>
          ...
          <li><a href="projectslist">View Projects</a></li>
       <!--    <li><a href="login">Login</a></li> -->
          ...
          <li class="drop-down"><a href="#">${username}</a>
           ...
           <!-- <li><a href="#" class="get-started-btn scrollto">Sign Up</a></li> -->
        </ul>
      </nav><!-- .nav-menu -->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="hero-container">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <ul class="todo-list">
             ...
             <c:forEach items="${pList}" var="project" varStatus="myIndex">
        <li onclick="javascript:show_pngimage('${project.projectId}');" style="cursor: pointer;">
                <div>
                   Project Name: <label class="label"><c:out value="${project.projectName}"/></label><br>
                  <span>Drawing : <c:out value="${project.drawingName}"/></span>
                </div>
              </li>
              <script>
                           ...
                           <!--  <li onclick="return loadimage('/files/4/drawings/PP_02.png')" style="cursor: pointer;">
                <div>
                   Project Name: <label class="label"> sample</label><br>
                  <span>Drawing : sample</span>
                </div>
              </li> -->
      ...
      <div class="col-xl-6 p-0">
       ...
       <%--       <img id="pic" src='<c:out value="${firstProjectImgPath}"/>' style="width: 100%;height: 50vh;object-fit: contain;">    --%>
    <!--         <img id="pic" src='#' style="width: 100%;height: 50vh;object-fit: contain;"> -->
...
<script>
function show_pngimage(projectId){
	console.log('--============projectId===========--'+projectId)
	URL = "/codecompilance/getDrawingPath";
	$.ajax({
		type: "POST",
		 async: false,  
		url : URL,
	data: { projectId: projectId},
		success : function(response){
			if(response != null && response !=""){
				...
				ccIndex = response.indexOf("codecompilance");
				ubuntuPngPath = response.substr(ccIndex + 14,response.length - ccIndex)
				console.log("=============ubuntuPngPath============="+ubuntuPngPath);
		//		$("#pic").attr("src",ubuntuPngPath);
				var img = $('<img />', { 
					  id: 'pic',
					  src: ubuntuPngPath,
					  style: 'width: 100%;height: 50vh;object-fit: contain;'
					});
					img.appendTo($('.paragraph-custom-scroll'));
			}
