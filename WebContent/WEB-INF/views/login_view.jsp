                                            ...
                                            <a href="#" class="dropdown-toggle arrow-none card-drop" data-bs-toggle="dropdown" aria-expanded="false">
                                                <i class="mdi mdi-dots-horizontal"></i>
                                                        ...
                                                        <div class="text-center py-1">
                                                            ...
                                                            <p class="font-size-14 mb-1">07 / 08 / 2022</p>
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <ul class="pagination pagination-rounded mb-sm-0">
                                                            ...
                                                            <c:if test="${totalCount > pageStart}">
	                                                            <li class="page-item">
	                                                                <a href="viewProjects??start=${pageStart + 10}" class="page-link">Next</a>
	                                                            </li>
                                                            </c:if>
                                                            <c:if test="${totalCount < pageStart}">
	                                                            <li class="page-item disabled">
	                                                    ...
	                                                    <form action="/${siteurl}/renameProject">
	                                                        <div class="modal-content">
	                                                            ...
	                                                            <div class="modal-body">
																	...
																	<input class="form-control" type="text" name="projectname" placeholder="Project Name" maxlength="30" required>
																	</div>
	                                                            </div>
