  ...
  <section id="hero" class="d-flex align-items-center">
	...
	<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
					<div class="card">
							<div class="card-body">
								<div class="m-sm-4">
									<form action="/${siteurl}/new_project" method="post" enctype="multipart/form-data">
										<div class="form-group">
											<label>Project Name</label>
											<input class="form-control form-control-lg" type="text" name="projectname" placeholder="Enter your name" />
										</div>
										<div class="form-group">
											<label>Drawing Type</label>
											<select name="drawingtype" class="form-control">
												<option value="0"> --Select One-- </option>
												<option value="1"> Residential Plan </option>
												<option value="2"> Commercial Plan</option>
												<option value="3"> Restaurant </option>
											</select>
										</div>
										<div class="form-group">
											<label>Drawing Name</label>
											<input class="form-control form-control-lg" type="text" name="drawingname" placeholder="Enter Drawing Name" />
										</div>
										<div class="form-group">
										...
										<div class="text-center mt-3">
											<!-- <a href="dashboard-default.html" class="btn btn-lg btn-primary">CreateProject</a> -->
											<button type="submit" class="btn btn-lg btn-primary">CreateProject</button>
										</div>
									</form>
								</div>
							</div>
