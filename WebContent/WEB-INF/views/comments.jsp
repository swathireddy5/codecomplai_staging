...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
							...
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">All Comments</h4>
							</div>
							</c:if>
							<c:if test="${empty commentsList}">
							<div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">No Comments</h4>
							</div>
							</c:if>
                                            ...
                                            <table class="table table-hover mb-0">
											  ...
											  <tr class="tab-item">
												  ...
												  <td id="tooltip-container9">
                                                      ...
                                                      <a href="#" onclick="deletecomment(${comment.userId},${comment.bookMarkId},'comment');" class="text-danger" data-bs-container="#tooltip-container9" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Delete" aria-label="Delete"><i class="mdi mdi-trash-can font-size-18"></i></a>
                                                  </td>
											  </tr>
									</c:forEach>
									</tbody>
        ...
        <script type="text/javascript">
			...
			function deletecomment(userId,bookmarkId,actionType){
